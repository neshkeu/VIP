...
export interface Driver {
  ...
  // Renta vozač
  daily_rate: number;          // Dnevna renta
  ...
  doprinosi_monthly: number;   // Doprinosi — mjesečno
...
export const calendarEvents: CalendarEvent[] = [
  // Marko
  { id: "ce1",  driver_id: "d1", date: "2026-03-03", type: "rent",    amount: 3500,  description: "Renta",           is_done: true,  done_by: "Nemanja", done_at: "2026-03-03" },
  { id: "ce2",  driver_id: "d1", date: "2026-03-05", type: "rent",    amount: 3500,  description: "Renta",           is_done: true,  done_by: "Milica",  done_at: "2026-03-05" },
  { id: "ce3",  driver_id: "d1", date: "2026-03-07", type: "off_day", amount: 1750,  description: "Slobodan dan",    is_done: true,  done_by: "Admin",   done_at: "2026-03-07" },
  { id: "ce4",  driver_id: "d1", date: "2026-03-10", type: "rent",    amount: 3500,  description: "Renta",           is_done: false },
  { id: "ce5",  driver_id: "d1", date: "2026-03-12", type: "rent",    amount: 3500,  description: "Renta",           is_done: false },
  { id: "ce6",  driver_id: "d1", date: "2026-03-14", type: "rent",    amount: 3500,  description: "Renta",           is_done: false },
  { id: "ce7",  driver_id: "d1", date: "2026-03-01", type: "pos_fee", amount: 800,   description: "POS mart 2025",   is_done: true,  done_by: "Admin",   done_at: "2026-03-01" },
  { id: "ce8",  driver_id: "d1", date: "2026-03-06", type: "debt",    amount: 15000, description: "Šteta — branik",  is_done: false },
  // Nemanja
  { id: "ce9",  driver_id: "d2", date: "2026-03-03", type: "rent",    amount: 3000,  description: "Renta",           is_done: true,  done_by: "Admin",   done_at: "2026-03-03" },
  { id: "ce10", driver_id: "d2", date: "2026-03-05", type: "rent",    amount: 3000,  description: "Renta",           is_done: true,  done_by: "Nemanja", done_at: "2026-03-05" },
  { id: "ce11", driver_id: "d2", date: "2026-03-10", type: "rent",    amount: 3000,  description: "Renta",           is_done: false },
  { id: "ce12", driver_id: "d2", date: "2026-03-12", type: "rent",    amount: 3000,  description: "Renta",           is_done: false },
  { id: "ce13", driver_id: "d2", date: "2026-03-01", type: "pos_fee", amount: 600,   description: "POS mart 2025",   is_done: false },
  { id: "ce14", driver_id: "d2", date: "2026-03-08", type: "fuel_vat",amount: 1200,  description: "PDV gorivo",      is_done: false },
  // Milica
  { id: "ce15", driver_id: "d3", date: "2026-03-03", type: "rent",    amount: 4000,  description: "Renta",           is_done: true,  done_by: "Admin",   done_at: "2026-03-03" },
  { id: "ce16", driver_id: "d3", date: "2026-03-05", type: "rent",    amount: 4000,  description: "Renta",           is_done: false },
  { id: "ce17", driver_id: "d3", date: "2026-03-10", type: "rent",    amount: 4000,  description: "Renta",           is_done: false },
  { id: "ce18", driver_id: "d3", date: "2026-03-01", type: "pos_fee", amount: 1000,  description: "POS mart 2025",   is_done: true,  done_by: "Milica",  done_at: "2026-03-02" },
  { id: "ce19", driver_id: "d3", date: "2026-03-07", type: "debt",    amount: 5000,  description: "Kazna saobraćaj", is_done: false },
  // Stefan
  { id: "ce20", driver_id: "d4", date: "2026-03-03", type: "rent",    amount: 3800,  description: "Renta",           is_done: false },
  { id: "ce21", driver_id: "d4", date: "2026-03-05", type: "rent",    amount: 3800,  description: "Renta",           is_done: false },
  { id: "ce22", driver_id: "d4", date: "2026-03-07", type: "off_day", amount: 1900,  description: "Slobodan dan",    is_done: true,  done_by: "Admin",   done_at: "2026-03-07" },
  { id: "ce23", driver_id: "d4", date: "2026-03-01", type: "pos_fee", amount: 750,   description: "POS mart 2025",   is_done: false },
  // Ana
  { id: "ce24", driver_id: "d5", date: "2026-03-03", type: "rent",    amount: 3200,  description: "Renta",           is_done: true,  done_by: "Milica",  done_at: "2026-03-03" },
  { id: "ce25", driver_id: "d5", date: "2026-03-05", type: "rent",    amount: 3200,  description: "Renta",           is_done: true,  done_by: "Milica",  done_at: "2026-03-05" },
  { id: "ce26", driver_id: "d5", date: "2026-03-10", type: "rent",    amount: 3200,  description: "Renta",           is_done: false },
  { id: "ce27", driver_id: "d5", date: "2026-03-01", type: "pos_fee", amount: 500,   description: "POS mart 2025",   is_done: true,  done_by: "Admin",   done_at: "2026-03-01" },
];

export const cashEntries: CashEntry[] = [
  { id: "k1",  driver_id: "d1", type: "rent_payment",    direction: "in",  amount: 3500, date: "2026-03-03", description: "Renta Marko",        received_by: "Nemanja", event_id: "ce1"  },
  { id: "k2",  driver_id: "d1", type: "rent_payment",    direction: "in",  amount: 3500, date: "2026-03-05", description: "Renta Marko",        received_by: "Milica",  event_id: "ce2"  },
  { id: "k3",  driver_id: "d2", type: "rent_payment",    direction: "in",  amount: 3000, date: "2026-03-03", description: "Renta Nemanja",      received_by: "Admin",   event_id: "ce9"  },
  { id: "k4",  driver_id: "d2", type: "rent_payment",    direction: "in",  amount: 3000, date: "2026-03-05", description: "Renta Nemanja",      received_by: "Nemanja", event_id: "ce10" },
  { id: "k5",  driver_id: "d1", type: "pos_fee_payment", direction: "in",  amount: 800,  date: "2026-03-01", description: "POS naknada Marko",  received_by: "Admin",   event_id: "ce7"  },
  { id: "k6",  driver_id: "d3", type: "pos_fee_payment", direction: "in",  amount: 1000, date: "2026-03-02", description: "POS naknada Milica", received_by: "Milica",  event_id: "ce18" },
  { id: "k7",  driver_id: "d3", type: "rent_payment",    direction: "in",  amount: 4000, date: "2026-03-03", description: "Renta Milica",       received_by: "Admin",   event_id: "ce15" },
  { id: "k8",  driver_id: "d5", type: "rent_payment",    direction: "in",  amount: 3200, date: "2026-03-03", description: "Renta Ana",          received_by: "Milica",  event_id: "ce24" },
  { id: "k9",  driver_id: "d5", type: "rent_payment",    direction: "in",  amount: 3200, date: "2026-03-05", description: "Renta Ana",          received_by: "Milica",  event_id: "ce25" },
  { id: "k10", driver_id: "d5", type: "pos_fee_payment", direction: "in",  amount: 500,  date: "2026-03-01", description: "POS naknada Ana",    received_by: "Admin",   event_id: "ce27" },
  { id: "k11", driver_id: null, type: "other_expense",   direction: "out", amount: 5000, date: "2026-03-04", description: "Gorivo za rezervno vozilo", received_by: "Admin" },
];
