                ...
                <div key={e.id}>
                  {editEntry?.id===e.id?(
                    <div className="flex items-center gap-2 rounded-md bg-muted/40 px-3 py-1.5">
                      ...
                      <Button size="sm" className="h-7 text-xs" disabled={saving} onClick={handleUpdateEntry}>{saving?<Loader2 className="h-3 w-3 animate-spin"/>:"Sačuvaj"}</Button>
                      <Button size="sm" variant="ghost" className="h-7 text-xs" onClick={()=>{setEditEntry(null);setEditAmount("");}}>✕</Button>
                    </div>
                  ):(
                    <div className="flex items-center justify-between rounded-md bg-muted/40 px-3 py-1.5 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button onClick={()=>handleDeleteEntry(e.id)} className="text-muted-foreground hover:text-destructive"><Trash2 className="h-3 w-3"/></button>
                      </div>
                    </div>
                  )}
                </div>
